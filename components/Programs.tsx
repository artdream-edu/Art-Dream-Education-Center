    ...
    <section id="programs" className="py-24 px-6 md:px-12 bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <h2 className="text-sm font-black tracking-widest uppercase mb-4" style={{ color: primaryColor }}>Business Areas</h2>
            <h3 className="text-4xl md:text-5xl font-bold">주요 사업 영역</h3>
          </div>
        </div>
