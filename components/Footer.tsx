    ...
    <footer className="py-20 px-6 md:px-12 border-t border-white/5 bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-medium">
              <li className="text-gray-400">info@artdreamschool.kr</li>
              <li className="text-gray-400">02-1234-5678</li>
              <li className="text-gray-400">서울특별시 종로구 세종대로 123</li>
            </ul>
          </div>
          <div>
            <h5 className="text-xs font-bold uppercase tracking-widest mb-6 text-white/50">Social</h5>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full glass flex items-center justify-center hover:scale-110 transition-transform">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-10 border-t border-white/5 text-[10px] font-bold tracking-widest text-gray-600 uppercase">
          <div>© 2024 ARTS DREAM SCHOOL. ALL RIGHTS RESERVED.</div>
